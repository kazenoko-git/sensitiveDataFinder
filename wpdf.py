...
# poppler_path = r'C:/Program Files/poppler-24.02.0/Library/bin' # Example path
# if not os.path.exists(poppler_path):
#     print(f"Warning: Poppler path '{poppler_path}' not found. Please verify your Poppler installation and path.")
#     poppler_path = None # Set to None if path is invalid, pdf2image will then rely on system PATH
...
def pdf_to_text(pdf_path: str, poppler_path: str = None) -> str:
    """
    ...
    Args:
        ...
        poppler_path (str, optional): The path to the Poppler 'bin' directory.
                                      Required if Poppler is not in system PATH. Defaults to None.
    ...
    try:
        ...
        print("or provide the 'poppler_path' argument to the pdf_to_text function.")
        return ""
    except Exception as e:
...
if __name__ == "__main__":
    ...
    try:
        ...
        extracted_text_pdf = pdf_to_text(dummy_pdf_path)
